...
faqs:
  ...
  - q: "If my 2012 truck passes the Davis Dam test physically, does that retroactively validate its rating?"
    a: "No. J2807 compliance requires the complete five-test protocol conducted in a standardized manner. Self-testing a single grade is not equivalent, even if an owner completes a similar climb at close to the rated maximum, that would still be informal, anecdotal experience rather than a J2807 validation."
...
No. J2807 compliance requires the complete five-test protocol conducted in a standardized manner. Self-testing a single grade is not equivalent, even if an owner completes a similar climb at close to the rated maximum, that would still be informal, anecdotal experience rather than a J2807 validation.
